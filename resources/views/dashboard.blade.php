...
<body class="bg-gray-100">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <aside class="bg-gradient-to-b bg-rose-600 text-white w-64 min-h-screen p-4">
            <div class="text-2xl font-bold mb-8 text-center">Luxe Location</div>
            <nav>
           
                <a href="{{route('user.read')}}" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-rose-700 hover:text-white mb-1 flex items-center">
                ...
                <a href="{{route('properties.readAdmin')}}" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-rose-700 hover:text-white mb-1 flex items-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                    Propriétés
                </a>
                <a href="{{route('reservationAd')}}" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-rose-700 hover:text-white mb-1 flex items-center">
                ...
                <a href="{{route('payment.Admin')}}" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-rose-700 hover:text-white mb-1 flex items-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                    payment
                </a>
                <a href="#" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-rose-700 hover:text-white mb-1 flex items-center">
